...
# ############################################################################
# facebook/galactica-1.3b, facebook/galactica-6.7b, facebook/galactica-30b
...
# create_citation, runs inference on the input test, returns mdoel output:
...
# Run the Streamlit app using streamlit run galactica_citation_demo.py --server.port 9999
